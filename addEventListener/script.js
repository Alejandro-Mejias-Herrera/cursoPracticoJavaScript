...
btnSuma.addEventListener('click',realizarSuma);
btnResta.addEventListener('click',realizarResta);
btnMultiplicacion.addEventListener('click',realizarMultiplicacion);
btnDivision.addEventListener('click',realizarDivision);
